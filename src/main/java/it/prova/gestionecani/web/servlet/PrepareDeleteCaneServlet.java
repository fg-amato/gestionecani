...
@WebServlet("/PrepareDeleteCaneServlet")
public class PrepareDeleteCaneServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			request.setAttribute("caneRichiesto",
		...
		request.getRequestDispatcher("/cane/delete.jsp").forward(request, response);
	}
